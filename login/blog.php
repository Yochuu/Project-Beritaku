...
<body>
    ...
    <section class="blog_area section-padding">
        <div class="container">
            <div class="row">
                <?php
                $query_all = mysqli_query($db, "SELECT * FROM berita JOIN kategori ON berita.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori != 'exclusive' ORDER BY RAND()") or die(mysqli_error($db));
