            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg mb-4 order-0">
                    <button type="button" class="mb-4 btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalInsert">
                      <i class="tf-icons bx bx-user-plus"></i> Tambah User
                    </button>
                    <?php
                      ...
                      <div class="p-3 table-responsive">
                        <table id="myTable" class="table table-striped">
                          ...
                          <tbody>
                            <?php
                            $no = 1;
                            $query_select = mysqli_query($db, "SELECT * FROM user");
                            while ($row = mysqli_fetch_assoc($query_select)) {
                              ...
                              <td>
                                <div class="d-grid gap-2 col-5 mx-auto">
                                  <a href="#" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modaledit<?= $no; ?>"><i class="bi bi-pen"></i> Edit Level</a>
                                      ...
                                      <form method="post" action="edit.php">
                                        ...
                                        <div class="input-group mb-3">
                                          ...
                                          <select name="level" id="role" class="form-select">
                                            ...
                                            <option value="premium" <?= ($row['level'] == 'premium') ? 'selected' : ''; ?>>Premium</option>
                                          </select>
                                        </div>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form method="post" action="delete.php">
                                        <p>Yakin untuk menghapus : <?= $row['level'] ?> <?= $row['username'] ?> ?</p>
                                        <input type="hidden" name="username" id="username" value="<?= $row['username'] ?>">
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              ...
              <div class="modal fade" id="modalInsert" tabindex="-1" aria-labelledby="modalInsertLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="modalInsertLabel">Tambah User</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                      </button>
                    </div>
                    <div class="modal-body">
