        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <a href="dashboard.php"> <img width="100%" src="../../assets/img/logo/logo.jpg" style="position: relative; right:10px; bottom:5px; width: -50%; " alt=""></a>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="read.php" class="menu-link">
                    <div data-i18n="Without navbar">Read</div>
                  </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="delete.php" class="menu-link">
                    <div data-i18n="Fluid">Delete</div>
                  </a>
                </li>
              </ul>
            </li>
