                                ...
                                <div class="properties__button">
                                    ...
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            ...
                                            <a class="nav-item nav-link" id="nav-exclusive" data-toggle="tab" href="#nav-exclusive" role="tab" aria-controls="nav-contact" aria-selected="false">Exclusive</a>
                                        </div>
                                    </nav>
                                    <!--End Nav Button  -->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <!-- Card exclusive -->
                                    <div class="tab-pane fade" id="nav-exclusive" role="tabpanel" aria-labelledby="nav-exclusive">
                                        <div class="whats-news-caption">
                                            <div class="row">
                                                <?php
                                                $query_exclusive = mysqli_query($db, "SELECT * FROM berita JOIN kategori ON berita.id_kategori = kategori.id_kategori WHERE kategori.id_kategori = 6 ORDER BY RAND()") or die(mysqli_error($db));
                                                while ($row = mysqli_fetch_array($query_exclusive)) :
                                                ?>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="single-what-news mb-100">
                                                            <div class="what-img">
